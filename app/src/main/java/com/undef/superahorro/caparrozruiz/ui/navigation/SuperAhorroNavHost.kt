...
import com.undef.superahorro.caparrozruiz.ui.screens.promotions.PromotionsScreen
        ...
        NavHost(
            ...
            composable(AppRoute.More) {
                MoreScreen(
                    ...
                    onOpenPromotions = { navController.navigate(AppRoute.Promotions) }
                )
            }
            composable(AppRoute.Promotions) {
                PromotionsScreen()
            }
