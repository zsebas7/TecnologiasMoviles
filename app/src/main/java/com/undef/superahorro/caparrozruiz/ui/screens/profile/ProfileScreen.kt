package com.undef.superahorro.caparrozruiz.ui.screens.profile
...
import com.undef.superahorro.caparrozruiz.ui.viewmodel.ProfileViewModel
...
fun ProfileScreen(viewModel: ProfileViewModel = viewModel()) {
    ...
    Column(
        ...
        Button(
            ...
            Text(text = if (uiState.saved) stringResource(R.string.profile_saved_label) else stringResource(R.string.profile_save_button))
        }
    }
}
